...
VkImageView application_create_image_view(application_t *app, VkImage image, VkFormat format) {
...
{
    app->textureImageView = application_create_image_view(app, app->textureImage, VK_FORMAT_R8G8B8A8_UNORM);
}
