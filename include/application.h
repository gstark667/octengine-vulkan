...
struct application_t
{
    ...
    pipeline_attachment_t colorAttachment, brightAttachment, normalAttachment, positionAttachment, fresnelAttachment, albedo, normal, position, currPosition, lastPosition, pbr, offscreenDepthAttachment, shadowPosition, sky, blurH, blurV, postColor, uiColor, uiDepth;
